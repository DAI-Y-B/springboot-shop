...
<head>
    ...
    <script type="text/javascript">
        window.onload = function () {
            document.getElementById("className").onblur = function () {
                var className = document.getElementById("className").value;
                $.ajax({
                    type: "POST",
                    url: "product/cateNameCheck.do",
                    async: true,
                    dataType: "json",
                    data: {
                        "className": className
...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>添加分类</h2>
        <div class="manage">
            <form action="product/productCategoryAdd.do" method="post">
                <table class="form">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="className" id="className"/></td>
                    </tr>
                    <tr>
                        <td></td>
