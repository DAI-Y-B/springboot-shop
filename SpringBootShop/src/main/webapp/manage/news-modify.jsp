...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>修改新闻</h2>
        <div class="manage">
            <form action="news/newsEdit.do" method="post">
                <input type="hidden" name="id" value="${news.nId}"/>
                <table class="form">
                    <tr>
                        <td class="field">新闻标题：</td>
                        <td><input type="text" class="text" name="title" value="${news.nTitle}"/></td>
                    </tr>
                    <tr>
                        <td class="field">新闻内容：</td>
                        <td><textarea name="content">${news.nContent }</textarea></td>
                    </tr>
                    <tr>
                        <td></td>
