...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>修改用户</h2>
        <div class="manage">
            <form action="<%=basePath %>manage/editUser.do" method="post">
                <table class="form">
                    <tr>
                        <td class="field">用户名：</td>
                        <td><input type="text" class="text" name="euUserName" id="euUserName" readonly="readonly"
                                   value="${someOneInfo.euUserName}"/></td>
                    </tr>
                    <tr>
                        <td class="field">姓名：</td>
                        <td><input type="text" class="text" name="euName" id="euName" value="${someOneInfo.euName}"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="field">密码：</td>
                        <td><input type="text" class="text" name="euPassword" id="euPassword"
                                   value="${someOneInfo.euPassword}"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="euIdentityCode" id="euIdentityCode"
                                   value="${someOneInfo.euIdentityCode}" readonly="readonly"/></td>
                    </tr>
                    <tr>
                        <td class="field">手机号码：</td>
                        <td><input type="text" class="text" name="euMobile" id="euMobile"
                                   value="${someOneInfo.euMobile}"/></td>
                    </tr>
                    <tr>
                        <td class="field">邮箱：</td>
                        <td><input type="text" class="text" name="euEmail" id="euEmail" value="${someOneInfo.euEmail}"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="field">送货地址：</td>
                        <td><input type="text" class="text" name="euAddress" id="euAddress"
                                   value="${someOneInfo.euAddress}"/></td>
                    </tr>
                    <tr>
                        <td class="field">用户类型：</td>
                        <td>
                            <select id="euStatus" name="euStatus">
                                <option value=" ${someOneInfo.euStatus }">${someOneInfo.roles.roleName}</option>
